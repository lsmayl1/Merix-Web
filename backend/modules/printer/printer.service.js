...
const { GetProductByIdOrBarcode } = require("../product/product.service");
const config = require("../../database/config.json");
const electron = require("electron");

const basePath =
  electron.app && electron.app.isPackaged
...
const PrintReceipt = (data) => {
  try {
    ...
    const doc = new PDFDocument({
      size: [width, dynamicHeight + 150],
      margin,
    });

    doc.registerFont("Inter", path.join(__dirname, "./fonts/Inter.ttf"));
    doc.font("Inter");
