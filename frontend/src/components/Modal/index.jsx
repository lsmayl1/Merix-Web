...
export const BaseModal = ({ isOpen, onClose, title, children, footer }) => {
  ...
  return (
    <div
      className="modal-backdrop z-50 bg-MaingBg/30 absolute flex items-center justify-center w-full h-full top-0 right-0"
      onClick={onClose}
    >
      <div
        className="modal border bg-white border-mainBorder w-1/2  flex rounded-lg p-4 gap-2 flex-col "
