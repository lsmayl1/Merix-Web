...
export const CashMovements = () => {
  ...
  return (
    <div className="w-full h-full flex flex-col  gap-2 relative">
      ...
      <KPI
        data={[
          { label: t("revenue"), value: data?.totalRevenue },
          { label: t("income"), value: data?.todayIncome },
          { label: t("expense"), value: data?.todayExpense },
          { label: t("total"), value: data?.todayTotal },
        ]}
      />
